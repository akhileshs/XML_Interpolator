...
//pattern liftables for XML literals.
//Due to XML node dissimilarity in tree representation, different liftable implementations had to be used. 
//This implementation generates pattern trees.
