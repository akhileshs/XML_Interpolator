/* Maintainer: Akhilesh Srikanth (akhilesh.srikanth@gmail.com) 
 * Stability: Experimental
 * License: See the file LICENSE *
 * XML string interpolator for Scala
 */
...
package xmlquote {
  ...
  //DOM typeclass interface (check this part again)
  object DOMPackage {
    implicit object DOM extends XMLContext {
